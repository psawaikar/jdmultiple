node {
    ...
    stage('Dev') {
        //echo "Hello World"
        frontend = docker.build('psawaikar/jdmultiple_frontend:2.0', "-f ${env.WORKSPACE}/frontend/Dockerfile .")
        backend = docker.build('psawaikar/jdmultiple_backend:2.0', "-f ${env.WORKSPACE}/backend/Dockerfile.qa .")
